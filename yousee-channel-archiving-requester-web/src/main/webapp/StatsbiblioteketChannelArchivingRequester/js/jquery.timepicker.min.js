...
!function (a) {
    ...
    function m(b, c) {
        if ("" !== this.value && "timepicker" != c) {
            var d = a(this);
            if (d.data("timepicker-list"), !d.is(":focus") || b && "change" == b.type) {
                var e = u(this.value);
                if (null === e)return d.trigger("timeFormatError"), void 0;
            ...
            if (!isNaN(d.getTime())) {
                ...
                for (var e, f, g = "", h = 0; h < c.length; h++)switch (f = c.charAt(h)) {
                    case"a":
                        ...
                        break;
                    case"A":
                        g += d.getHours() > 11 ? x.pm.toUpperCase() : x.am.toUpperCase();
                        break;
                    case"g":
    ...
    function u(a, b) {
        ...
        var c = new RegExp("^([0-2]?[0-9])\\W?([0-5][0-9])?\\W?([0-5][0-9])?\\s*(" + x.am + "|" + x.pm + ")?$"), d = a.match(c);
        if (!d)return null;
        var e = parseInt(1 * d[1], 10), f = d[4], g = e;
        12 >= e && f && (g = 12 == e ? d[4] == x.pm ? 12 : 0 : e + (d[4] == x.pm ? 12 : 0));
        var h = 1 * d[2] || 0, i = 1 * d[3] || 0, j = 3600 * g + 60 * h + i;
        if (!f && b && b._twelveHourTime && b.scrollDefault) {
            var k = j - b.scrollDefault;
            0 > k && k >= w / -2 && (j = (j + w / 2) % w)
        }
        return j
    }

    var v = h(), w = 86400, x = {am: "am", pm: "pm", AM: "AM", PM: "PM", decimal: ".", mins: "mins", hr: "hr", hrs: "hrs"}, y = {init: function (b) {
        ...
        if (f.useSelect)return e.data("timepicker-list").focus(), void 0;
        j(e) && e.blur();
